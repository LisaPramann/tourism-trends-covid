...
authors: "by Kathryn Malchow, Lisa Pramann, Renato Franco"
...
<center>
```{r, echo=FALSE,out.width="50%", out.height="20%",fig.show='hold',fig.align='center'}
